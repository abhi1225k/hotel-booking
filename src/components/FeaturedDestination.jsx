...
const FeaturedDestination = () => {
  ...
  return (
    ...
    py-20'>
        ...
        <Title title='Featured Destination' subTitle='with friends. A lifetime of memories. Service like never before; Count the stars; Creating spaces for you; Have a grand vacation ...'/>
