...
const Addroom = () => {
  ...
  return (
      ...
      <form>
        <Title align='left' font='outfit' title='Add Room' subTitle='fill the details carefully and accurate room details,price and amenities to enhance the user booking experience.'/>
        {/* upload images */}
          ...
          <div className='flex-1 max-w-48'>
            <p className='text-gray-800 mt-4'>Room Type</p>
               ...
               className='border opacity-70 border-gray-300 mt-1 rounded p-2 w-full'>
                ...
                <option value='super-deluxe'>Double Room</option>
                <option value='suite'>Luxury Room</option>
                <option value='suite'>FamilySuite</option>
               </select>
              ...
              {Object.keys(inputs.amenities).map((amenity, index)=>(
                <div key={index}>
                  <input type='checkbox' id={`amenities${index+1}`} 
                    checked={inputs.amenities[amenity]} onchange={()=>({...inputs,amenities: {...inputs.amenities,[amenity]: !inputs.amenities[amenity]}})}
                  />
